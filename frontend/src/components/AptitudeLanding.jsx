          ...
          {aptitudeTopics.map((topic) => {
            ...
            return (
              <Card 
                ...
                onClick={() => {
                  if (topic.id === 'quantitative') {
                    onNavigate('quantitative-landing');
                  } else if (topic.id === 'logical') {
                    onNavigate('logical-landing');
                  } else if (topic.id === 'verbal') {
                    onNavigate('verbal-landing');
                  }
                }}
              >
                {/* Background Pattern */}
