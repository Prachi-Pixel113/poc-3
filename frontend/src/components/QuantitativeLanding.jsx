...
const QuantitativeLanding = ({ onNavigate, onBack }) => {
  ...
  // Simplified topics structure without categorized subtopics
  ...
  const totalQuestions = quantitativeTopics.reduce((total, topic) => total + topic.questions, 0);
  const totalTopics = quantitativeTopics.length;
            ...
            {quantitativeTopics.map((topic) => (
              ...
              >
                ...
                <div className="absolute inset-0 opacity-5">
                  <div className="absolute -right-3 -top-3 w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-500 to-transparent rounded-full"></div>
                  <div className="absolute -left-3 -bottom-3 w-16 h-16 bg-gradient-to-tr from-emerald-500 to-teal-500 to-transparent rounded-full"></div>
                </div>

                <CardHeader className="pb-3 relative">
                  <div className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center mb-3 shadow-md">
